...
let state=store.get('applus-state',{name:'Apprentice',signature:'',courseId:'brick',completed:{},drafts:{},rewards:[],academyPassed:{},academyScores:{},academyCompletionDates:{},academyTestPassed:{},academyTestScores:{},witnessTestimonies:{},practicalAssessments:{},tab:'home'});
state.signature=state.signature||''; state.academyPassed=state.academyPassed||{}; state.academyScores=state.academyScores||{}; state.academyCompletionDates=state.academyCompletionDates||{}; state.academyTestPassed=state.academyTestPassed||{};state.academyTestScores=state.academyTestScores||{};state.witnessTestimonies=state.witnessTestimonies||{}; state.practicalAssessments=state.practicalAssessments||{};
